...
class EdaTab(QtWidgets.QWidget):
    def __init__(self, parent=None):
        ...
        self.sb_threshold = QtWidgets.QDoubleSpinBox(); self.sb_threshold.setRange(0, 1e9); self.sb_threshold.setDecimals(6); self.sb_threshold.setValue(0.1)
...
class PandasModel(QtCore.QAbstractTableModel):
    ...
    def headerData(self, section, orientation, role=QtCore.Qt.DisplayRole):
        ...
        return self._df.columns[section] if orientation == QtCore.Qt.Horizontal else section + 1
